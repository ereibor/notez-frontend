...
const cardData = [
  {
    ...
    title: "Journaling",
    description:
      "Capture your daily reflections in a serene, distraction-free environment.",
    color: "bg-pink",
  },
  {
    ...
    description:
      "Organize notes by life areas like Health, Career, and Relationships.",
    color: "bg-sage",
  },
  {
    ...
    title: "Goal Tracking",
    description:
      "Set intentions and track your progress with visual indicators.",
    color: "bg-yellow",
  },
  {
